...
<body id="background">
    <div class="container mx-auto mt-10">
        <div class="max-w-6xl mx-auto p-6 rounded-lg shadow-lg">
            <div class="text-box">
                <h2 class="great-vibes-regular font-bold text-center">Welcome to our wedding</h2>
                <p class="sacramento-regular font-bold text-center">A.Z {{ date('Y') }}</p>
            </div>
            <!-- Upload Button -->
            ...
            <div id="gallery" class="grid-container">
                @if ($uploads->isEmpty())
                    <p class="demo text-white text-center font-bold col-span-full" style="z-index: 1;"
                        id="demo"></p>
                @else
